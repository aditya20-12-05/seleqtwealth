...
(function() {
  ...
  // Country dialing codes. India first (default), the rest alphabetical.
  const countries = [
    ['India', '+91'],
    ...
    ['Congo (Republic)', '+242'], ['Costa Rica', '+506'], ["Côte d'Ivoire", '+225'],
    ['Croatia', '+385'], ['Cuba', '+53'], ['Cyprus', '+357'],
    ['Czech Republic', '+420'], ['Denmark', '+45'], ['Djibouti', '+253'],
    ['Dominica', '+1'], ['Dominican Republic', '+1'], ['Ecuador', '+593'],
    ['Egypt', '+20'], ['El Salvador', '+503'], ['Equatorial Guinea', '+240'],
    ...
    ['Hungary', '+36'], ['Iceland', '+354'], ['Indonesia', '+62'],
    ['Iran', '+98'], ['Iraq', '+964'], ['Ireland', '+353'],
    ['Israel', '+972'], ['Italy', '+39'], ['Jamaica', '+1'],
    ...
    ['Lithuania', '+370'], ['Luxembourg', '+352'], ['Macau', '+853'],
    ...
    ['Russia', '+7'], ['Rwanda', '+250'], ['Saint Kitts and Nevis', '+1'],
    ['Saint Lucia', '+1'], ['Saint Vincent and the Grenadines', '+1'], ['Samoa', '+685'],
    ['San Marino', '+378'], ['Sao Tome and Principe', '+239'], ['Saudi Arabia', '+966'],
    ['Senegal', '+221'], ['Serbia', '+381'], ['Seychelles', '+248'],
    ['Sierra Leone', '+232'], ['Singapore', '+65'], ['Slovakia', '+421'],
    ['Slovenia', '+386'], ['Solomon Islands', '+677'], ['Somalia', '+252'],
    ['South Africa', '+27'], ['South Korea', '+82'], ['South Sudan', '+211'],
    ...
    ['Vatican City', '+379'], ['Venezuela', '+58'], ['Vietnam', '+84'],
  ...
  if (wrap) {
    ...
    // Accent-insensitive: "cote" should match "Côte d'Ivoire"
    ...
    countries.forEach(([name, dial]) => {
      ...
      li.dataset.search = norm(name + ' ' + dial + ' ' + dial.replace('+', ''));
